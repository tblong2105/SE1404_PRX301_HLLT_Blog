...
public class Blog {
	...
	public Blog(String title, String category, String sortDescription, String longDescription, String image,
			String authorName, String authorPosition, String authorImage) {
		super();
		this.title = title;
